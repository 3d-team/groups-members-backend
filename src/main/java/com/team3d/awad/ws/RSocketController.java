...
import com.team3d.awad.payload.SubscribePresentationMetadata;
...
public class RSocketController {
    ...
    public RSocketController(ObjectMapper mapper, SharingPresentationManager presentationManager, Flux<String> stream) {
        this.mapper = mapper;
